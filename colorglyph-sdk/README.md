...
soroban contract bindings ts \
  ...
  --id CCCI5CPRMWUM5UCBZUY2YAYM5EE5TVR3NIBMNYYA7DLSZWSCQWCURRYY \
  --name colorglyph-sdk
```
...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url https://rpc-futurenet.stellar.org:443 --network-passphrase \"Test SDF Future Network ; October 2022\" --id CCCI5CPRMWUM5UCBZUY2YAYM5EE5TVR3NIBMNYYA7DLSZWSCQWCURRYY --name colorglyph-sdk"
}
```
