...
soroban contract bindings ts \
  ...
  --id CCSFGKSGV2OPMD45DIW2M4ZXIBZAJ73C23IBZO4KD4FQTZREX6HXHXFE \
  --name colorglyph-sdk
```
...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url https://rpc-futurenet.stellar.org:443 --network-passphrase \"Test SDF Future Network ; October 2022\" --id CCSFGKSGV2OPMD45DIW2M4ZXIBZAJ73C23IBZO4KD4FQTZREX6HXHXFE --name colorglyph-sdk"
}
```
