...
/**
 * Invoke a method on the colorglyph-sdk contract.
 *
...
export async function invoke({ method, args = [], fee = 100, signAndSend = false }: InvokeArgs): Promise<(TxResponse & { xdr: string }) | Simulation> {
  ...
  const account = freighterAccount ?? new SorobanClient.Account('GD7QBQNZF72UWC3VINURR6VELVIPU534DCL5EWP2HPZWM5HR6RJTAE6G', '0')
