...
export async function glyphTransfer({ from, to, hash }, options = {}) {
    return await invoke({
...
export async function glyphScrape({ owner, to, hash_type }, options = {}) {
    return await invoke({
        method: 'glyph_scrape',
        args: [((i) => addressToScVal(i))(owner),
            ((i) => (!i) ? xdr.ScVal.scvVoid() : addressToScVal(i))(to),
...
export async function glyphGet({ address, hash_type }, options = {}) {
    return await invoke({
        method: 'glyph_get',
