...
async function glyphTransfer({ from, to, hash }, options = {}) {
    return await (0, invoke_js_1.invoke)({
        method: 'glyph_transfer',
        args: [((i) => (0, convert_js_1.addressToScVal)(i))(from),
            ((i) => (0, convert_js_1.addressToScVal)(i))(to),
            ((i) => (!i) ? soroban_client_1.xdr.ScVal.scvVoid() : soroban_client_1.xdr.ScVal.scvBytes(i))(hash)],
        ...options,
        parseResultXdr: () => { },
    });
}
exports.glyphTransfer = glyphTransfer;
async function glyphScrape({ owner, to, hash_type }, options = {}) {
    return await (0, invoke_js_1.invoke)({
        method: 'glyph_scrape',
        args: [((i) => (0, convert_js_1.addressToScVal)(i))(owner),
            ((i) => (!i) ? soroban_client_1.xdr.ScVal.scvVoid() : (0, convert_js_1.addressToScVal)(i))(to),
...
async function glyphGet({ address, hash_type }, options = {}) {
    return await (0, invoke_js_1.invoke)({
        method: 'glyph_get',
        args: [((i) => (!i) ? soroban_client_1.xdr.ScVal.scvVoid() : (0, convert_js_1.addressToScVal)(i))(address),
            ((i) => HashTypeToXdr(i))(hash_type)],
        ...options,
        parseResultXdr: (xdr) => {
            try {
