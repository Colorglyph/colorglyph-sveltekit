...
export async function glyphTransfer<R extends ResponseTypes = undefined>({from, to, hash}: {from: Address, to: Address, hash: Option<Buffer>}, options: {
  /**
   * The fee to pay for the transaction. Default: 100.
   */
  fee?: number
  ...
  secondsToWait?: number
    ...
    return await invoke({
        ...
        args: [((i) => addressToScVal(i))(from),
        ((i) => addressToScVal(i))(to),
        ((i) => (!i) ? xdr.ScVal.scvVoid() : xdr.ScVal.scvBytes(i))(hash)],
        ...options,
        parseResultXdr: () => {},
    });
}

export async function glyphScrape<R extends ResponseTypes = undefined>({owner, to, hash_type}: {owner: Address, to: Option<Address>, hash_type: HashType}, options: {
  /**
   * The fee to pay for the transaction. Default: 100.
   */
  fee?: number
...
export async function glyphGet<R extends ResponseTypes = undefined>({address, hash_type}: {address: Option<Address>, hash_type: HashType}, options: {
  /**
   * The fee to pay for the transaction. Default: 100.
   */
  fee?: number
  ...
  secondsToWait?: number
    ...
    return await invoke({
        method: 'glyph_get',
        args: [((i) => (!i) ? xdr.ScVal.scvVoid() : addressToScVal(i))(address),
        ((i) => HashTypeToXdr(i))(hash_type)],
        ...options,
...
export type HashType = {tag: "Colors", values: void} | {tag: "Dust", values: void} | {tag: "Glyph", values: [Buffer]};
